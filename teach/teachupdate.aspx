<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teachupdate.aspx.cs" Inherits="tuixuan.teach.teachupdate" %>
    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                <li><a class="on" href="teachindex.aspx">首页</a></li>
            </ul>
        </div>
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="coursetablemana.aspx"><i class="iconfont icon-banjixinxi"></i>班级信息</a></li>
                    </ul>
                </li>
                <li>
    ...
    <!--/sidebar-->
     <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="teachindex.aspx">个人信息</a><span class="crumb-step">&gt;</span><span class="crumb-name">修改</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">工号</label><asp:TextBox ID="TextBox1" runat="server" 
                             ReadOnly="True"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">姓名</label><asp:TextBox ID="TextBox2" runat="server" 
                           ></asp:TextBox>
                    </li>
                     <li>
