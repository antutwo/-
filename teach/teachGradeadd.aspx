<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teachGradeadd.aspx.cs" Inherits="tuixuan.teach.teachGradeadd" %>
    ...
    <div class="sidebar-wrap">
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="teachGrade.aspx" style="background-color:#009688;color:white"><i class="iconfont icon-banjixinxi"></i>班级信息</a></li>
                    </ul>
                </li>
                <li>
     ...
     <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="teachGrade.aspx">班级信息</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增学生</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">学生性别</label><asp:DropDownList ID="DropDownList2" runat="server"  class="common-text"
                            Height="25px" Width="341px">
                            <asp:ListItem>男</asp:ListItem>
                            <asp:ListItem>女</asp:ListItem>
                        </asp:DropDownList>
                    </li>
                    <li>
                        <label class="res-lab">所在班级</label><asp:TextBox ID="TextBox3" runat="server" class="common-text"
                            Height="25px" Width="341px" CssClass="auto-style1" ReadOnly="True"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">个人密码</label><asp:TextBox ID="TextBox4" runat="server" class="common-text"
