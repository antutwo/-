<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addCandidate.aspx.cs" Inherits="tuixuan.teach.addCandidate" %>
    ...
    <div class="sidebar-wrap">
     ...
     <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="voteManage.aspx">候选管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增侯选人</span></div>
        </div>
