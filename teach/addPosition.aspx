<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addPosition.aspx.cs" Inherits="tuixuan.teach.addPosition" %>
    ...
    <div class="sidebar-wrap">
     ...
     <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="voteManage.aspx">投票管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增项目</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                      <li>
                        <label class="res-lab">项目</label><asp:TextBox ID="TextBox1" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">人数</label><asp:TextBox ID="TextBox2" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">最大候选人数</label><asp:TextBox ID="TextBox3" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                     <li>
                        <label class="res-lab">要求</label><asp:TextBox ID="TextBox4" runat="server" class="common-text" TextMode="MultiLine"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                     <li>
                        <label class="res-lab">评选人数</label><asp:TextBox ID="TextBox5" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                     <li>
                        <label class="res-lab">投票数</label><asp:TextBox ID="TextBox6" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
