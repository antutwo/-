<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="candidateManage.aspx.cs" Inherits="tuixuan.teach.candidateManage" %>
...
<div class="container clearfix">
  ...
  <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">候选管理</span></div>
        </div>
                     ...
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="state" HeaderText="评选状态" />
                             ...
                             <asp:BoundField DataField="num" HeaderText="正在候选人数" />
                             <asp:BoundField DataField="elect_num" HeaderText="评选人数" />
                             <asp:ButtonField ButtonType="Button" CommandName="btn_votes" Text="查看详情" />
                        </Columns>
