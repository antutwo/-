<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeBehind="teachGrade.aspx.cs" Inherits="tuixuan.teach.teachGrade" %>
    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                ...
                <!--<li><a class="on" href="teachindex.aspx">学生推选管理系统</a></li>-->
...
<div class="container clearfix">
    <div class="sidebar-wrap">
        <div class="sidebar-title">
            <h1>菜单</h1>
            <!--<h2 style="font-weight:normal;">教师首页</h2>-->
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">班级信息</span></div>
        </div>
                     ...
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="stu_sex" HeaderText="学生性别" />
                             ...
                             <asp:BoundField DataField="stu_password" HeaderText="学生密码" />
                             <asp:BoundField DataField="grade_name" HeaderText="班级名" ReadOnly="True" />
