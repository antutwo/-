<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="notVoted.aspx.cs" Inherits="tuixuan.teach.notVoted" %>
...
<div class="container clearfix">
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="voteDetails.aspx">投票信息</a><span class="crumb-step">&gt;</span><span class="crumb-name">未投票信息</span></div>
        </div>
