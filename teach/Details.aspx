<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="tuixuan.teach.Details" %>
...
<div class="container clearfix">
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="voteDetails.aspx">投票信息</a><span class="crumb-step">&gt;</span><span class="crumb-name">投票详细信息</span></div>
        </div>
            ...
            <asp:Label ID="title" runat="server" Font-Bold="False" Font-Size="X-Large"></asp:Label>
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             <asp:BoundField DataField="vote_id" HeaderText="投票ID" Visible="False" />
                            ...
                            <asp:BoundField DataField="grade_id" HeaderText="班号" ReadOnly="True" />
                             ...
                             <asp:BoundField DataField="vote_name" HeaderText="投票人" ReadOnly="True">
                             <ControlStyle Width="20px" />
                             </asp:BoundField>
                             <asp:BoundField DataField="votes" HeaderText="投票数" ReadOnly="True" />
                        </Columns>
