<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeBehind="electManage.aspx.cs" Inherits="tuixuan.teach.electManage1" %>
...
<div class="container clearfix">
  ...
  <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">评选管理</span></div>
        </div>
        ...
        <div class="result-wrap">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <asp:Button ID="Button3" class="btn btn-info btn2" runat="server" Text="新增" 
                                    style="margin:auto;" onclick="Button3_Click" Height="31px" />
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             <asp:BoundField DataField="elect_id" HeaderText="评选号" Visible="False" />
                            <asp:BoundField DataField="position" HeaderText="项目" />
                            <asp:BoundField DataField="stu_id" HeaderText="学号" />
                            <asp:BoundField DataField="elect_name" HeaderText="姓名" />
                           
                             <asp:BoundField DataField="position_vote" HeaderText="票数" ReadOnly="True" />
                             <asp:BoundField DataField="votes" HeaderText="已投票数" ReadOnly="True" />
