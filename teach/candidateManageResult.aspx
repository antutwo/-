<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="candidateManageResult.aspx.cs" Inherits="tuixuan.teach.candidateManageResult" %>
    ...
    <!--/main-->
     ...
     <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="candidateManage.aspx">候选管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">候选结果</span></div>
        </div>
