<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="candidateDetails.aspx.cs" Inherits="tuixuan.teach.candidateDetails" %>
...
<div class="container clearfix">
  ...
  <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="candidateManage.aspx">候选管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">候选管理详情</span></div>
        </div>
            ...
            <div class="search-content">
                    <table class="search-tab">
                        <tr>
                            <th width="70">关键字:</th>
                            <td> 
                                  <asp:TextBox  class="common-text"  placeholder="候选人姓名关键字" ID="findinfo" runat="server" Height="25px" Width="140px"></asp:TextBox>
                            </td>
                            <td style="align-content:center">
                              
                                <asp:Button ID="Button1" class="btn btn-primary btn2" runat="server" Text="查询" 
                                    style="margin:auto;" onclick="Button1_Click" Height="31px" /></td>
                            <td></td>
                        </tr>
                    </table>
            </div>
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             <asp:BoundField DataField="candidate_id" HeaderText="候选号" ReadOnly="True" Visible="False" />
                             <asp:BoundField DataField="position" HeaderText="项目" />
                            <asp:BoundField DataField="stu_id" HeaderText="学号" />
                            <asp:BoundField DataField="candidate_name" HeaderText="姓名" />
