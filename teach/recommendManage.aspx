<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="recommendManage.aspx.cs" Inherits="tuixuan.teach.recommendManage" %>
...
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="recommendManage.aspx" style="background-color:#009688;color:white"><i class="iconfont icon-menu_tpgl"></i>推荐管理</a></li>
                    </ul>
                </li>
            </ul>
        </div>
  ...
  <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="teachindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">推荐管理</span></div>
        </div>
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             <asp:BoundField DataField="temporary_id" HeaderText="推荐号" Visible="False" />
                            ...
                            <asp:BoundField DataField="stu_name" HeaderText="姓名" />
                             ...
                             <asp:BoundField DataField="refer_name" HeaderText="推荐人" ReadOnly="True" />
                             <asp:BoundField DataField="grade_id" HeaderText="班号" ReadOnly="True" />
                           
                             <asp:ButtonField ButtonType="Button" CommandName="btn_addT" HeaderText="添加" Text="同意" />
                             <asp:ButtonField ButtonType="Button" CommandName="btn_del" HeaderText="取消" Text="删除" />
                        </Columns>
