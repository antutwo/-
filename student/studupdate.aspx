<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studupdate.aspx.cs" Inherits="tuixuan.student.studupdate" %>
    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                <li><a class="on" href="studindex.aspx">首页</a></li>
            </ul>
        </div>
    ...
    <!--/sidebar-->
     <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="studindex.aspx">个人信息</a><span class="crumb-step">&gt;</span><span class="crumb-name">修改</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">学号</label><asp:TextBox ID="TextBox1" runat="server" 
                            ReadOnly="True"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">姓名</label><asp:TextBox ID="TextBox2" runat="server" ReadOnly="True" 
                            ></asp:TextBox>
                    </li>
                       <li>
                        <label class="res-lab">性别</label><asp:TextBox ID="TextBox6" runat="server" ReadOnly="True" 
                           ></asp:TextBox>
                    </li>
                     <li>
                        <label class="res-lab">密码</label><asp:TextBox ID="TextBox3" runat="server" 
                           ></asp:TextBox>
                    </li>
                     <li>
                        <label class="res-lab">班号</label><asp:TextBox ID="TextBox4" runat="server" 
                             ReadOnly="True"></asp:TextBox>
                    </li>
                     <li>
                        <label class="res-lab">班级</label><asp:TextBox ID="TextBox5" runat="server" 
                             ReadOnly="True"></asp:TextBox>
                    </li>
