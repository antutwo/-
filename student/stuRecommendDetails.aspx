<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeBehind="stuRecommendDetails.aspx.cs" Inherits="tuixuan.student.stuRecommendDetails" %>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="studrecommend.aspx"><i class="iconfont icon-info"></i>推荐信息</a></li>
                         <li><a href="stuRecommendDetails.aspx" style="background-color:#009688;color:white"><i class="iconfont icon-12"></i>推荐详情</a></li>
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">推荐详情</span></div>
        </div>
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             <asp:BoundField DataField="temporary_id" HeaderText="推荐ID" Visible="False" />
                            <asp:BoundField DataField="position" HeaderText="项目" ReadOnly="True" />
                           
                             <asp:BoundField DataField="grade_id" HeaderText="班号" />
                             <asp:BoundField DataField="stu_id" HeaderText="被推荐人学号" />
                            <asp:BoundField DataField="stu_name" HeaderText="被推荐人姓名" />
                           
                             <asp:BoundField DataField="refer_name" HeaderText="推荐人" />
                             <asp:BoundField DataField="refer_state" HeaderText="推荐状态" />
                           
                             <asp:ButtonField ButtonType="Button" CommandName="btn_del" Text="取消推荐" HeaderText="取消" />
                             <asp:ButtonField ButtonType="Button" CommandName="btn_look" HeaderText="查看" Text="查看候选详情" />
                        </Columns>
