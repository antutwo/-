<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="stuGrade.aspx.cs" Inherits="tuixuan.student.stuGrade" %>
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="stuGrade.aspx" style="background-color:#009688;color:white;"><i class="iconfont icon-banjixinxi"></i>班级信息</a></li>
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">班级信息</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                    <table class="search-tab">
                        <tr>
                            <th width="70">关键字:</th>
                            <td><asp:TextBox class="common-text" placeholder="学生姓名关键字" ID="findinfo" runat="server" Type="text" OnTextChanged="findinfo_TextChanged"></asp:TextBox></td>
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="position" HeaderText="候选项目" />
