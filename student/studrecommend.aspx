<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="studrecommend.aspx.cs" Inherits="tuixuan.student.studrecommend" %>
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">推荐信息</span></div>
        </div>
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             ...
                             <asp:BoundField DataField="position_name" HeaderText="项目名称" />
                            <asp:BoundField DataField="number" HeaderText="人数" ReadOnly="True" />
                           
                             <asp:BoundField DataField="text" HeaderText="评选要求" />
                             <asp:BoundField DataField="state" HeaderText="评选状态" />
                            <asp:BoundField DataField="num" HeaderText="在候选人数" />
                           
                             <asp:BoundField DataField="maximun" HeaderText="最大候选人数" />
                             <asp:BoundField DataField="elect_num" HeaderText="评选人数" />
                           
                             <asp:ButtonField ButtonType="Button" CommandName="btn_add" Text="评选推荐" />
                        </Columns>
