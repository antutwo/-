<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="tuixuan.student.add" %>
...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="studrecommend.aspx" style="background-color:#009688;color:white"><i class="iconfont icon-info"></i>推荐信息</a></li>
    ...
    <div class="main-wrap">
       <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="studrecommend.aspx">推荐信息</a><span class="crumb-step">&gt;</span><span class="crumb-name">添加</span><span class="crumb-step">&gt;</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">项目</label><asp:TextBox ID="TextBox1" runat="server" 
                            ReadOnly="True"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">班号</label><asp:TextBox ID="TextBox2" runat="server" ReadOnly="True" 
                            ></asp:TextBox>
                    </li>
                       <li>
                        <label class="res-lab">姓名</label><asp:TextBox ID="TextBox3" runat="server" 
                           ></asp:TextBox>
                    </li>
                     <li>
                        <label class="res-lab">学号</label><asp:TextBox ID="TextBox4" runat="server" 
                           ></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">推荐人</label><asp:TextBox ID="TextBox5" runat="server" 
                           ></asp:TextBox>
                    </li>
                    ...
                    <li>
                        ...
                        <asp:Button ID="Button1" runat="server" class="btn btn-success btn6 mr10"
                            Text="确认推荐" Height="33px" Width="100px" OnClientClick="return confirm('每一个项目只有一次推荐机会，你确定吗?');" onclick="Button1_Click" />
                    </li>
                </ul>
            </div>
        </div>
