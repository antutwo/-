<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="voteCandidate.aspx.cs" Inherits="tuixuan.student.voteCandidate" %>
...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="studvotes.aspx" style="background-color:#009688;color:white"><i class="iconfont icon-canyutoupiao"></i>参与投票</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="studvotes.aspx">参与投票</a><span class="crumb-step">&gt;</span><span class="crumb-name">评选人投票页面</span></div>
        </div>
            ...
            <div class="search-content">
                    <table class="search-tab">
                        <tr>
                            <th width="70">可投票数:</th>
                            <td><asp:TextBox class="common-text" ID="TextBox1" runat="server" Type="text" ReadOnly="True"></asp:TextBox></td>
                            <th width="70">已投票数:</th>
                            <td><asp:TextBox class="common-text" ID="TextBox2" runat="server" Type="text" ReadOnly="True"></asp:TextBox></td>
                             <td> &nbsp;</td>
                     ...
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="candidate_name" HeaderText="候选人姓名" />
                             ...
                             <asp:ButtonField ButtonType="Button" CommandName="btn_votesAdd" Text="投票" />
                        </Columns>
