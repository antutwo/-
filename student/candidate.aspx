<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="candidate.aspx.cs" Inherits="tuixuan.student.candidate" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">我的候选信息</span></div>
        </div>
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             <asp:BoundField DataField="candidate_id" HeaderText="候选号" Visible="False" />
                            <asp:BoundField DataField="position" HeaderText="候选项目" ReadOnly="True" />
                            <asp:BoundField DataField="candidate_state" HeaderText="候选状态" />
                           
                             <asp:BoundField DataField="votes" HeaderText="获选票数" />
                             <asp:ButtonField ButtonType="Button" CommandName="btn_voteDetails" Text="查看投票详情" HeaderText="查看" >
                            
                             
                            
                             </asp:ButtonField>
                             <asp:CommandField DeleteText="取消候选" HeaderText="取消" ShowDeleteButton="True" />
                        </Columns>
