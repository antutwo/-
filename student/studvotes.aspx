<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="studvotes.aspx.cs" Inherits="tuixuan.student.studvotes" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="studindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">参与投票</span></div>
        </div>
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                             ...
                             <asp:BoundField DataField="position_name" HeaderText="项目" />
                            ...
                            <asp:BoundField DataField="state" HeaderText="评选状态" />
                             ...
                             <asp:ButtonField ButtonType="Button" CommandName="btn_votes" Text="查看候选" />
                        </Columns>
