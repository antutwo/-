...
public class DataBase:IDisposable
{
    ...
    private void Open()
    {
        ...
        if (con == null)
        {
            String ConStr = "Data Source=LAPTOP-2DFKBE3R\\SQLEXPRESS;Initial Catalog=ayt_22_tx_cs;Integrated Security=True";
            /*con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConStr"].ToString());   ---此处是用web.config来设置一个name为ConStr
             连接字符串来做连接字符串连接数据库*/
            con = new SqlConnection(ConStr);//连接
    ...
    /// </summary>
    /// <param name="procName">命令文本</param>sql语句
    /// <param name="prams">参数对象</param>
    /// <returns></returns>
