<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacherLogin.aspx.cs" Inherits="tuixuan.adminLogin.teacherLogin" %>
    ...
    <div class="login layui-anim layui-anim-up">
        <div style="text-align:center;" >
            ...
            <form id="form1" runat="server" class="layui-form" >
                ...
                <div>
                    <asp:Label runat="server" ID="lbl1">工号:</asp:Label>
                    <asp:TextBox ID="teachid" runat="server" lay-verify="required" class="layui-input" CssClass="layui-form-switch"></asp:TextBox>
                </div>
                  <div>
                ...
                <div class="login_code">
                       验证码:<br />
                        <input name="code" type="text" id="code" style="width:auto; height: 50px;" maxlength="4" autocomplete="off" runat="server" />
                        <img alt="" src="../Control/validate.aspx" id="getcode_img"  title="看不清请点击！" class="auto_style1" />
