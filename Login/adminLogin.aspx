<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="tuixuan.Login.adminLogin" %>
    ...
    <div class="login layui-anim layui-anim-up">
        <div style="text-align:center;" >
            ...
            <form id="form1" runat="server" class="layui-form" >
                ...
                <div>
                    <asp:Label runat="server" ID="lbl1">用户名:</asp:Label>
                    <asp:TextBox ID="username" runat="server" lay-verify="required" class="layui-input" CssClass="layui-form-switch"></asp:TextBox>
                </div>
                  <div>
                ...
                <div class="login_code">
                       验证码:<br />
                        ...
                        <img alt="" src="../Control/validate.aspx" id="getcode_img" class="auto_style1" title="看不清请点击！" />
                       
                 </div>
                <br />
                <div>
                    <asp:Button runat="server" ID="submit" lay-filter="login" style="width:100%;" Text="登录" OnClick="submit_Click" />
