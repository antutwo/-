<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="grademanage.aspx.cs" Inherits="tuixuan.admin.grademanage" %>
...
<div class="container clearfix">
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="adminindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">班级管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                    <table class="search-tab">
                        <tr>
                            <th width="70">关键字:</th>
                            <td><asp:TextBox class="common-text" placeholder="班级名关键字" ID="findinfo" runat="server" Type="text" OnTextChanged="findinfo_TextChanged"></asp:TextBox></td>
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="grade_name" HeaderText="班名" />
