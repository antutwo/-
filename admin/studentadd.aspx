<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentadd.aspx.cs" Inherits="tuixuan.admin.studentadd" %>
    ...
    <div class="sidebar-wrap">
     ...
     <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="adminindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="studentmanage.aspx">学生管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增学生</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">所在班级</label><asp:DropDownList ID="DropDownList1" runat="server"  class="common-text"
                            Height="25px" Width="341px">
                        </asp:DropDownList>
                    </li>
                    <li>
