<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacheradd.aspx.cs" Inherits="tuixuan.admin.teacheradd" %>
    ...
    <div class="sidebar-wrap">
     ...
     <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="adminindex.aspx">首页</a><span class="crumb-step">&gt;</span><a href="teachermanage.aspx">教师管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增教师</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">所带班级</label><asp:DropDownList ID="DropDownList1" runat="server"  class="common-text"
