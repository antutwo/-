<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="teachermanage.aspx.cs" Inherits="tuixuan.admin.teachermanage" %>
...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="teachermanage.aspx"  style="background-color:#009688;color:white"><i class="iconfont icon-jiaoshiguanli2"></i>教师管理</a></li>
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="adminindex.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">教师管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                    <table class="search-tab">
                        <tr>
                            <th width="70">关键字:</th>
                            <td><asp:TextBox class="common-text" placeholder="教师姓名关键字" ID="findinfo" runat="server" Type="text"></asp:TextBox></td>
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="teacher_id" HeaderText="教师工号" ReadOnly="True" />
                            <asp:BoundField DataField="teacher_name" HeaderText="教师姓名" />
                            <asp:BoundField DataField="grade_id" HeaderText="所带班级号" />
                            <asp:BoundField DataField="teacher_password" HeaderText="登录密码" />
